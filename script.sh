...
rm -fr menu
rm -fr /usr/sbin/menu
wget https://github.com/MRJ-Badshah/internet/raw/main/menu/menu.zip
unzip menu.zip
rm -fr menu.zip
chmod +x *
clear
cd /usr/local/bin
wget https://github.com/MRJ-Badshah/internet/raw/main/ws.zip
unzip ws.zip
rm -fr ws.zip
chmod +x *
chmod +x /usr/bin/*
...
<span style="color: #e19d00fb">╰┈─────✩✩✩─────➤</span>
</b>
END
cd
chown -R www-data:www-data /home/vps/public_html
